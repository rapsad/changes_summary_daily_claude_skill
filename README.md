...
```bash
curl -fsSL https://raw.githubusercontent.com/dawidpolchlopek/changes-summary-daily-claude-skill/main/install.sh | bash
```

### Option B — Clone and run locally

```bash
git clone https://github.com/dawidpolchlopek/changes-summary-daily-claude-skill.git
